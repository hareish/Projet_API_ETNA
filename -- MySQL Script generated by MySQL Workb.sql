-- MySQL Script generated by MySQL Workbench -- Mon Apr 29 16:24:30 2019 -- Model: 
New Model Version: 1.0 
-- MySQL Workbench Forward Engineering SET 
...
SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='TRADITIONAL,ALLOW_INVALID_DATES';
 ...
 -- ----------------------------------------------------- -- Table `mydb`.`user`-- ----------------------------------------------------- 
 CREATE TABLE IF NOT EXISTS `mydb`.`user` ( `id` INT NOT NULL, 
 ...
 CREATE TABLE IF NOT EXISTS `mydb`.`video` ( `id` INT NOT NULL, 
 `name` VARCHAR(45) NOT NULL, 
 `duration` INT NULL, `user_id` INT NOT NULL, 
 `source` VARCHAR(45) NOT NULL, `created_at` DATETIME NOT NULL, 
 `view` INT NOT NULL, `enabled` TINYINT(1) NOT NULL, PRIMARY KEY (`id`), 
 ...
 CREATE TABLE IF NOT EXISTS `mydb`.`video_format` ( `id` INT NOT NULL, 
 `code` VARCHAR(45) NOT NULL, `uri` VARCHAR(45) NOT NULL, 
 `video_id` INT NOT NULL, PRIMARY KEY (`id`), 
 ...
 -- ----------------------------------------------------- -- Table `mydb`.`token` -- ----------------------------------------------------- 
 CREATE TABLE IF NOT EXISTS `mydb`.`token` ( `id` INT NOT NULL, 
 `code` VARCHAR(45) NOT NULL, `expired_at` DATETIME NOT NULL, 
 ...
 -- ----------------------------------------------------- -- Table `mydb`.`comment` -- ----------------------------------------------------- 
 CREATE TABLE IF NOT EXISTS `mydb`.`comment` ( `id` INT NOT NULL, 
 `body` LONGTEXT NULL, `user_id` INT NOT NULL, 
 `video_id` INT NOT NULL, PRIMARY KEY (`id`), 
